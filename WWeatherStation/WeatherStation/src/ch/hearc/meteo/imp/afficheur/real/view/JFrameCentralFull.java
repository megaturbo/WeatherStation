...
public class JFrameCentralFull extends JFrame implements JFrameFull_I {

	/*------------------------------------------------------------------*\
	|*							Constructeurs							*|
	\*------------------------------------------------------------------*/

	public JFrameCentralFull(Manager manager) {
	...
	private void createMenuBar() {
		...
		itemSelectCom.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				Object o = JOptionPane.showInputDialog(JFrameCentralFull.this,
