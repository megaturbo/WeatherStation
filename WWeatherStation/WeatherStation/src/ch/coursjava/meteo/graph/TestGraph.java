...
public class TestGraph extends ApplicationFrame {
	...
	private JFreeChart createChart(XYDataset dataset) {
		...
		final JFreeChart chart = ChartFactory.createXYLineChart(
				"Correlation café/java", // chart title
				"Nombre de cafés consommés", // x axis label
				"Aptitude à coder du java", // y axis label
				dataset, // data
	...
	private XYDataset createDataset() {
		final XYSeries series1 = new XYSeries("Lundi matin après piscine");
		series1.add(1.0, 1.0);
		series1.add(2.0, 4.0);
		series1.add(3.0, 3.0);
		series1.add(4.0, 5.0);
